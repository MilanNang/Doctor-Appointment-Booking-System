  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
      <div className="card w-96 p-8">
        ...
        <button
          onClick={handleLogin}
          className="w-full py-2.5 rounded-md font-semibold text-white bg-yellow-500 hover:bg-yellow-600 transition"
        >
          Sign In
        </button>
        ...
        <div className="mt-6 text-center text-sm muted space-y-2">
          <p>
            ...
            <Link to="/signup" className="text-yellow-600 font-medium hover:text-yellow-700">
              Sign up
            </Link>
          </p>
          <p>
            <Link to="/" className="text-yellow-600 font-medium hover:text-yellow-700">
              ← Back to Home
            </Link>
          </p>
        </div>

      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <div className="card p-6 text-center">
            <p className="text-4xl font-bold text-yellow-600 mb-2">₹{totalAmount || "0.00"}</p>
          ...
          <div className="card p-6 text-center">
            <p className="text-4xl font-bold text-orange-600 mb-2">{safePayments.filter((p) => p.status === "pending").length}</p>

        ...
        <div className="bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-2xl p-8 text-white mb-8">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-2xl text-yellow-100 mb-4">{doctor.specialization}</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-lg p-6 shadow-md border-l-4 border-yellow-500">
              <h2 className="text-xl font-bold text-gray-900 mb-4">Consultation Fee</h2>
              <div className="flex items-baseline gap-2">
                <span className="text-4xl font-bold text-yellow-600">₹{doctor.fees}</span>
            ...
            <div className="bg-white rounded-lg p-6 shadow-md">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">MD in {doctor.specialization}</span>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-yellow-500 rounded-full mt-2 flex-shrink-0"></div>
                  <span className="text-gray-700">Board Certified Specialist</span>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-yellow-500 rounded-full mt-2 flex-shrink-0"></div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-lg p-6 sticky top-24">
              <div className="mb-6">
                <h3 className="text-lg font-bold text-gray-900 mb-4">Ready to Book?</h3>
                <div className="space-y-3 text-sm text-gray-600 mb-6">
                  ...
                  <div className="flex items-start gap-3">
                    <span className="text-lg font-bold text-yellow-600">₹{doctor.fees}</span>
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-yellow-500 to-yellow-600 text-white font-bold py-3 rounded-lg hover:shadow-lg transition mb-3"
              >
                Book Appointment
              </button>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {Object.entries(doctor.availability).map(([day, times]) => {
                ...
                return (
                  ...
                  >
                    <p className="font-bold text-gray-900 mb-2 capitalize">{day}</p>
                    {hasSlots ? (

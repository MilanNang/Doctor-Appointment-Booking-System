      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="card p-6 mb-8 space-y-4">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <select
              className="px-4 py-2.5 border border-gray-300 rounded-lg bg-white hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-500 transition cursor-pointer"
        ...
        {doctorsToShow.length < filteredDoctors.length && (
          <div className="flex justify-center mt-12">
            <button
              ...
              className="px-8 py-3 border-2 border-yellow-500 text-yellow-600 rounded-lg hover:bg-yellow-50 transition font-medium"
            >
              Load More Doctors
            </button>
          </div>
